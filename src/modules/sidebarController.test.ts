  ...
  const controller = new SidebarController({
    api: () => ({
      getSystemLocations: async () => ({
        ...
        videos: '/Users/testuser/Movies',
        applications: '/Applications',
        favorites: [
          { name: 'Applications', path: '/Applications' },
          { name: 'Desktop', path: '/Users/testuser/Desktop' },
          { name: 'Documents', path: '/Users/testuser/Documents' },
          { name: 'Developer', path: '/Users/testuser/Developer' },
          { name: 'Downloads', path: '/Users/testuser/Downloads' },
        ],
        drives: [],
      }),
    }),
    state: { active: 'left', left: { path: '/Users/testuser' } },
    setStatus: () => {},
    navigateTo: async () => {},
    focusActiveList: () => {},
  });
